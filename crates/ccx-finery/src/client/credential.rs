...
use super::signer::{FinerySigner, FinerySignerPayload};

/// Finery.io API credentials.
#[derive(Clone, Default, Serialize, Deserialize)]
#[serde(default)]
pub struct FineryCredential {
    pub(crate) key: String,
    pub(crate) secret: String,
}

impl FineryCredential {
    pub fn new(key: String, secret: String) -> Self {
        FineryCredential { key, secret }
    }
}

impl FinerySigner for FineryCredential {
    fn api_key(&self) -> &str {
        &self.key
    }
...
///
/// [Api documentation](https://www.finery.io/docs/developers/apiv4/#apiv4-signed-request-requirements)
///
...
mod tests {
    ...
    /// [source](https://www.finery.io/docs/finerypay/common/en/#_2-4-2-signature-algorithm)
