...
pub fn to_request_content<T: Request>(request: &T) -> Result<RequestContent, FineryError> {
    Ok(match T::HTTP_METHOD {
        ...
        // different parts of the request. https://www.finery.io/docs/developers/apiv4/#http-convention
